...
//------------------------------------------------------------------------------
// Returns an expression as a negative value. Denoted by '-' preceeding the expression. 

double neg_exp(Token_stream& tkn_strm, vector<Variable>& var_table);

//------------------------------------------------------------------------------
// Returns an expression as a positive value. Denoted by '+' preceeding the expression.
